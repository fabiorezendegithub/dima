...
public class CategoryHandler(AppDbContext context) : ICategoryHandler
{
    ...
    public async Task<Response<Category?>> UpdateAsync(UpdateCategoryRequest request)
    {
        try
        {
            ...
            await context.SaveChangesAsync();
            return new Response<Category?>(category, message: "A categoria foi atualizada com sucesso.");
    ...
    public async Task<Response<Category?>> DeleteAsync(DeleteCategoryRequest request)
    {
        try
        {
            ...
            await context.SaveChangesAsync();
            return new Response<Category?>(category, message: "A categoria foi excluida com sucesso.");
    ...
    public async Task<Response<Category?>> GetByIdAsync(GetCategoryByIdRequest request)
    {
        ...
        {
            return new Response<Category?>(null, 500, "Erro ao procurar categoria");
        }
    }
